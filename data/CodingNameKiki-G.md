1. No need to explicitly initialize variables with default values in for loops
...
2. Use ++i instead of i++ in for loops.
...
3. Use a memory location instead of storage

Using storage pointer instead of memory location can save a decent amount of gas.
a) few functions in the contract OperatorRegistry, use a memory location to retrieve Validator
...
4. ++i can be unchecked in the for loops.

There is no chance to overflow
