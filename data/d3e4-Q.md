...
**Layout convention**
Events should be declared after Type declarations and State variables, and before Modifiers and Functions.

Instances: ERC20PermitPermissionedMint.sol, frxETHMinter.sol, OperatorRegistry.sol